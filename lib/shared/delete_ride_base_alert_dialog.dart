...
class DeleteRideBaseAlertDialog extends StatelessWidget {

  String title, content, yes, no, uid;

  DeleteRideBaseAlertDialog({this.title, this.content, this.yes, this.no, this.uid});
            ...
            actions: <Widget>[
              new FlatButton(
                ...
                onPressed: () async {
                  ...
                  await databaseService.deleteRide(uid);
